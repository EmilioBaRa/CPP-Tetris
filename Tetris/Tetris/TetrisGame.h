...
private:
	...
	void drawGhostBlock(const Point& topLeft, int xOffset, int yOffset, TetColor color);

	void drawGhostTetromino(const GridTetromino& tetromino, const Point& topLeft);
